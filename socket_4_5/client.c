...
int main(int argc, char** argv) {
    ...
    */
    ...
    sendto(sockfd, buf, (opCount*4)+1+(opCount-1), 0, (struct sockaddr*)&servaddr, sizeof(servaddr)); // 피연산자수Byte + 피연산자들 Byte + 연산자들 Byte // 표준입력으로 받은 데이터를 char배열로
                                                                                                      // 받아 한번에 sendto()로 전송
